# QVAC Fake Spam Email Subject Line Generator

Type a topic and an on-device AI writes an over-the-top fake spam email subject line about it, with a deterministic clickbait meter.
...
Then open http://localhost:29388
